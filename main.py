...
try: app_id = int(os.environ.get("app_id", 14749248))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "ac7262da70edad8a5bbc1175b194e2fe")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "5687797057:AAF7qAc-U3xIFOOyEv1VhzXrb2s4GgDGIl0")
...
<b>All you have to do is add me to your channel and I will change captions of new posts into its file name</b>
<b>@shadow_linkz</b>"""
...
<b>• Updates : <a href=https://t.me/night_shadowz>Click Here</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/shadow_linkz"),
